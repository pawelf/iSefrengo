...
* Last Modified..: $Date: 2008-05-11 21:18:49 +0200 (Sun, 11 May 2008) $
* CVS Revision...: $Revision: 28 $
...
*/
	function dynCalendar_writeHTML()
	{
		if (is_ie5up || is_nav6up || is_gecko) {
			document.write('<a href="javascript: ' + this.objName + '.show()"><img class="calgif" src="' + this.imagesPath + 'dynCalendar.gif" border="0" width="16" height="16" /></a>');
